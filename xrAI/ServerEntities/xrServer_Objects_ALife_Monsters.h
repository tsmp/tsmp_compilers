...
#include "..\Graph\associative_vector.h"
...
#define script_type_list save_type_list(CSE_ALifePsyDogPhantom)
	...
	SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeHumanAbstract, CSE_ALifeTraderAbstract,
		CSE_ALifeMonsterAbstract) public : ALife::_OBJECT_ID m_group_id;
...
#define script_type_list save_type_list(CSE_ALifeHumanStalker)
	...
	SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeOnlineOfflineGroup, CSE_ALifeDynamicObject,
		CSE_ALifeSchedulable) public : CSE_ALifeOnlineOfflineGroup(LPCSTR caSection);
