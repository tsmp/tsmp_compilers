...
struct CDataStorageBucketList
{
	...
	class CDataStorage : public CDataStorageDoubleLinkedList<false>::CDataStorage<_data_storage,
							 BucketList<_vertex>::_vertex>
	{
	public:
		typedef typename CDataStorageDoubleLinkedList<false>::CDataStorage<_data_storage,
			BucketList<_vertex>::_vertex>
			inherited;
