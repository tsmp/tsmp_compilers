...
BOOL __stdcall TLHELPGetLoadedModules(DWORD dwPID, UINT uiCount, HMODULE *paModArray,
	LPDWORD pdwRealCount);
...
DWORD __stdcall TLHELPGetModuleFileNameEx(DWORD dwPID, HANDLE hProcess, HMODULE hModule,
