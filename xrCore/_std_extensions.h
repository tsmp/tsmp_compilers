...
IC void strcpy_s(char *strDestination, const char *strSource) { strcpy(strDestination, strSource); }

IC void _strlwr_s(char *strDestination, size_t sizeInBytes) { strlwr(strDestination); }
