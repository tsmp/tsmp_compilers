...
void FlushLog() { FlushLog(logFName); }
...
void AddOne(const char *split)
{
	...
	if (0 != strstr(Core.Params, "-alwaysflush"))
		FlushLog();
}
...
void Log(const char *msg, const Fmatrix &dop)
{
	...
	sprintf_s(buf, sizeof(buf), "%s:\n%f,%f,%f,%f\n%f,%f,%f,%f\n%f,%f,%f,%f\n%f,%f,%f,%f\n", msg,
		dop.i.x, dop.i.y, dop.i.z, dop._14_, dop.j.x, dop.j.y, dop.j.z, dop._24_, dop.k.x, dop.k.y,
...
LPCSTR log_name() { return (logFName); }
