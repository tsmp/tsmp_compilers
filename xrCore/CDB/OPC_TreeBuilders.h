...
public:
	...
	/**
		 ...
		 */
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	virtual bool ComputeGlobalBox(const unsigned int *primitives, unsigned int nb_prims,
	...
	/**
		 ...
		 */
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	virtual float GetSplittingValueEx(const unsigned int *primitives, unsigned int nb_prims,
		const AABB &global_box, unsigned int axis) const
	{
...
public:
	...
	virtual float GetSplittingValue(const unsigned int *primitives, unsigned int nb_prims,
		const AABB &global_box, unsigned int axis) const;
