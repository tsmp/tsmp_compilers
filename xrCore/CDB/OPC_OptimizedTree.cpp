 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void _BuildNoLeafTree(AABBNoLeafNode *linear, const unsigned int boxid, unsigned int &curid,
...
#define PERFORM_QUANTIZATION                                                                       \
	...
	((float *)mNodes[i].mAABB.mCenter)[0] =                                                        \
		signed short(Nodes[i].mAABB.mCenter.x * CQuantCoeff.x);                                    \
	((float *)mNodes[i].mAABB.mCenter)[1] =                                                        \
		signed short(Nodes[i].mAABB.mCenter.y * CQuantCoeff.y);                                    \
	((float *)mNodes[i].mAABB.mCenter)[2] =                                                        \
		signed short(Nodes[i].mAABB.mCenter.z * CQuantCoeff.z);                                    \
	((float *)mNodes[i].mAABB.mExtents)[0] =                                                       \
		unsigned short(Nodes[i].mAABB.mExtents.x * EQuantCoeff.x);                                 \
	((float *)mNodes[i].mAABB.mExtents)[1] =                                                       \
		unsigned short(Nodes[i].mAABB.mExtents.y * EQuantCoeff.y);                                 \
	((float *)mNodes[i].mAABB.mExtents)[2] =                                                       \
		unsigned short(Nodes[i].mAABB.mExtents.z * EQuantCoeff.z);                                 \
	/* Fix quantized boxes */                                                                      \
	if (gFixQuantized)                                                                             \
	{                                                                                              \
