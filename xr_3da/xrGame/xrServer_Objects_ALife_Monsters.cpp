...

	{
		...
		for (; I != E; ++I)
			*I = READ_IF_EXISTS(pSettings, r_float, imm_section,
				strcat(strcpy(S, ALife::g_cafHitType2String(ALife::EHitType(I - B))), "_immunity"),
				1.f);
	}
...
#ifdef XRGAME_EXPORTS
	m_stay_after_death_time_interval = generate_time(1, 1, 1,
		pSettings->r_u32("monsters_common", "stay_after_death_time_interval"), 0, 0);
#endif // XRGAME_EXPORTS
}
