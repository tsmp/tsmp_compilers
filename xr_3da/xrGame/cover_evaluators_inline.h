...
IC CCoverEvaluatorBestByTime::CCoverEvaluatorBestByTime(CRestrictedObject *object)
	: inherited(object)
{
}
...
IC CCoverEvaluatorRandomGame::CCoverEvaluatorRandomGame(CRestrictedObject *object)
	: inherited(object)
{
