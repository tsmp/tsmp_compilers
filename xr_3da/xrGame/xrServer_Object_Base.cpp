...
xr_token game_types[] = {{"any game", GAME_ANY}, {"single", GAME_SINGLE},
	{"deathmatch", GAME_DEATHMATCH},
	//	{ "CTF",			GAME_CTF		},
	//	{ "assault",		GAME_ASSAULT	},
	{"counterstrike", GAME_CS}, {"teamdeathmatch", GAME_TEAMDEATHMATCH},
	{"artefacthunt", GAME_ARTEFACTHUNT}, {0, 0}};

void CSE_Abstract::FillProps(LPCSTR pref, PropItemVec &items)
{
#if (defined(XRGAME_EXPORTS) && defined(DEBUG)) || defined(XRSE_FACTORY_EXPORTS)
	...
	PHelper().CreateFlag32(items, PrepareKey(pref, *s_name, "Spawn\\enabled"), &m_spawn_flags,
		flSpawnEnabled);
