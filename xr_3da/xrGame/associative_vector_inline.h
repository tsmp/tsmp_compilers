...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_iterator _associative_vector::lower_bound(
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_iterator _associative_vector::upper_bound(
	const key_type &key) const
{
	actualize();
	const value_compare &self = *this;
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::equal_range_result _associative_vector::equal_range(
	const key_type &key)
{
	actualize();
	iterator I = lower_bound(key);
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_equal_range_result _associative_vector::equal_range(
	const key_type &key) const
{
	actualize();
	const_iterator I = lower_bound(key);
