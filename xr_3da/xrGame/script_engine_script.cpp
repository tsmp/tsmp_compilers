...
#endif
bool GetShift() { return (GetAsyncKeyState(VK_SHIFT) & 0x8000) != 0; }
bool GetLAlt() { return (GetAsyncKeyState(VK_LMENU) & 0x8000) != 0; }
bool GetRAlt() { return (GetAsyncKeyState(VK_RMENU) & 0x8000) != 0; }
bool GetAlt() { return (GetAsyncKeyState(VK_MENU) & 0x8000) != 0; }

void CScriptEngine::script_register(lua_State *L)
{
	open_additional_libs(L);						 //RvP
	module(L)[def("log1", (void (*)(LPCSTR)) & Log), //RvP
		...
		class_<enum_exporter<IRender_interface::ScreenshotMode>>("screenshot_modes")
			.enum_("modes")[value("normal", int(IRender_interface::ScreenshotMode::SM_NORMAL)),
